...
function Contact() {
  ...
  const sendContactMail = async (
    ...
    try {
      const response = axios.post(`${apiBaseUrl}/api/contact`, newContactMail);
    } catch (error) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    sendContactMail(firstName, lastName, email, phoneNumber, message);
    setFirstName("");
    setLastName("");
    setEmail("");
    setPhoneNumber("");
    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Our sales team is on standby to attend to you as soon as possible.
        </p>
      </div>
      <form
        // action="#"
