    ...
    <div className="relative isolate overflow-hidden  py-20 sm:py-20">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <br />
          <h3 className="text-2xl font-bold tracking-tight text-black sm:text-5xl">
            Interpretation
          </h3>
          <br />
          <p className="mt-6 text-lg leading-8 text-gray-600">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            For the purposes of this Privacy Policy: <br /> • Account means a
            unique account created for You to access our Service or parts of our
            Service. <br /> • Affiliate means an entity that controls, is
            controlled by or is under common control with a party, where
            "control" means ownership of 50% or more of the shares, equity
            interest or other securities entitled to vote for election of
            directors or other managing authority. <br /> • Company (referred to
            as either "the Company", "We", "Us" or "Our" in this Agreement)
            refers to Eziwork Enterprise, Tema Comm. 1, Mankoadze. <br /> •
            Cookies are small files that are placed on Your computer, mobile
            device or any other device by a website, containing the details of
            Your browsing history on that website among its many uses. <br /> •
            Country refers to: Ghana <br /> • Device means any device that can
            access the Service such as a computer, a cellphone or a digital
            tablet. <br /> • Personal Data is any information that relates to an
            identified or identifiable individual. <br /> • Service refers to
            the Website. <br /> • Service Provider means any natural or legal
            person who processes the data on behalf of the Company. It refers to
            third-party companies or individuals employed by the Company to
            facilitate the Service, to provide the Service on behalf of the
            Company, to perform services related to the Service or to assist the
            Company in analyzing how the Service is used. <br /> • Usage Data
            ...
            EziData, accessible from https://ezidatagh.com <br /> • You means
          ...
          <br />
          <h4 className="text-1xl font-bold tracking-tight text-black sm:text-3xl">
            Personal Data
          </h4>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            is not limited to: <br /> • Email address <br /> • First name and
            last name <br /> • Phone number <br /> • Usage Data
          </p>
          <br />
          <h4 className="text-1xl font-bold tracking-tight text-black sm:text-3xl">
            Usage Data
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            technologies We use may include: <br /> • Cookies or Browser
            ...
            more about cookies on TermsFeed website article. We use both Session
            and Persistent Cookies for the purposes set out below: <br /> •
            ...
            provide You with those services. <br /> • Cookies Policy / Notice
            Acceptance Cookies Type: Persistent Cookies Administered by: Us
            Purpose: These Cookies identify if users have accepted the use of
            cookies on the Website. <br /> • Functionality Cookies Type:
            Persistent Cookies Administered by: Us Purpose: These Cookies allow
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            usage of our Service. <br /> • To manage Your Account: to manage
            Your registration as a user of the Service. The Personal Data You
            provide can give You access to different functionalities of the
            Service that are available to You as a registered user. <br /> • For
            ...
            when necessary or reasonable for their implementation. <br /> • To
            ...
            have opted not to receive such information. <br /> • To manage Your
            requests: To attend and manage Your requests to Us. <br /> • For
            business transfers: We may use Your information to evaluate or
            conduct a merger, divestiture, restructuring, reorganization,
            dissolution, or other sale or transfer of some or all of Our assets,
            whether as a going concern or as part of bankruptcy, liquidation, or
            similar proceeding, in which Personal Data held by Us about our
            Service users is among the assets transferred. <br /> • For other
            ...
            situations: <br /> • With Service Providers: We may share Your
            personal information with Service Providers to monitor and analyze
            the use of our Service, to contact You. <br /> • For business
            ...
            publicly distributed outside. <br /> • With Your consent: We may
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            that such action is necessary to: <br /> • Comply with a legal
            obligation <br /> • Protect and defend the rights or property of the
            Company <br /> • Prevent or investigate possible wrongdoing in
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            us: <br /> • By visiting this page on our website:
            <a href="https://ezidatagh.com/contact">
              https://ezidatagh.com/contact
            </a>
          </p>
        </div>
      </div>
